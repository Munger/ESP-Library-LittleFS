...
#define SER_FS_MOUNTING                 "Koppel bestandssysteem..."
#define SER_FS_PART_NOT_FOUND           "Bestandssysteem Partitie Niet gevonden"
#define SER_CERTIFICATE_NOT_FOUND       "Certificaat Niet gevonden!"
#define SER_CERTIFICATE_NOT_LOADED      "Kon certificaat niet laden!"

#define SER_UPD_FS_TO_LARGE             "Bestandssyteem update te groot!"
