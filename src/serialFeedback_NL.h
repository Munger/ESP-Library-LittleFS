...
#define SER_LittleFS_MOUNTING             "Koppel LittleFS..."
#define SER_LittleFS_PART_NOT_FOUND       "LittleFS Partitie Niet gevonden"
#define SER_CERTIFICATE_NOT_FOUND       "Certificaat Niet gevonden!"
#define SER_CERTIFICATE_NOT_LOADED      "Kon certificaat niet laden!"

#define SER_UPD_LittleFS_TO_LARGE         "LittleFS update te groot!"
